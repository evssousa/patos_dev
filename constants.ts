...
export const STUDENT_DUCKS = [
  { duckName: "Arrascaeta JR", owner: "Antonio Helder" },
  { duckName: "Bia", owner: "Francisco Tiago" },
  { duckName: "Bob Souza Gurgel", owner: "Anna Beatryz Gomes Gurgel" },
  { duckName: "Debug Bucetildes", owner: "Raven Teixeira Cruz" },
  { duckName: "Fofuxo Rodrigues Castro", owner: "Maria Eloisa " },
  { duckName: "Carne de Porco", owner: "Riquelme Ladislau da Silva" },
  { duckName: "ROBERTOOR (o amargurado)", owner: "Sophia Cordeiro" },
  { duckName: "Patonhão", owner: "Caio Breno Duarte Pires" },
  { duckName: "Zézinho Bernardo", owner: "Yasmin silva" },
  { duckName: "Pica Pau", owner: "Soraia" },
  { duckName: "José Patolino Barroso de Azevedo", owner: "Evelin Maria " },
  { duckName: "Bentinho", owner: "Ana Heloisa Gomes Angelo" },
  { duckName: "Guilherme", owner: "Felipe Freitas Rebouças" },
  { duckName: "Xerequinha", owner: "Carlos Alves" },
